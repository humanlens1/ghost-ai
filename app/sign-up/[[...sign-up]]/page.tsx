        ...
        <div className="relative flex-shrink-0" style={{ height: 280 }}>
          ...
          >
            <defs>
              ...
              <radialGradient id="su-cyan" cx="25%" cy="50%" r="45%">
                <stop
                  offset="0%"
              ...
              <radialGradient id="su-purple" cx="75%" cy="45%" r="40%">
                <stop
                  offset="0%"
            ...
            <rect width="800" height="280" fill="url(#su-grid)" />
            <rect width="800" height="280" fill="url(#su-cyan)">
              <animate
            ...
            <rect width="800" height="280" fill="url(#su-purple)">
              <animate
                attributeName="opacity"
                values="0.8;1;0.8"
                dur="7s"
