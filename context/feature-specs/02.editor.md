...
- Right section stays empy for now
- dark background with subtle bottom border

### Project Sidebar

Create `components/editor/project-sidebar.tsc`.

Requirements:

- Sidebar should float above the editor canvas
- opening it should not page page content
...
Use the existing color tokens from `globals.css` for fialog styling.
